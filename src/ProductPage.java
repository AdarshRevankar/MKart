...
public class ProductPage extends JPanel {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    try {
                        ...
                        products = (Products) XMLJavaReadWriters.readFromXML("Products", System.getProperty("user.dir") + "/src/xml/product.xml");
    ...
    private String[] fetchProducts() throws FileNotFoundException, JAXBException, ClassNotFoundException {
        Products products = (Products) XMLJavaReadWriters.readFromXML("Products", System.getProperty("user.dir") + "/src/xml/product.xml");
